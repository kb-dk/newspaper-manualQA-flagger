...
public class FlaggingFinderTest {
    ...
    public void testJp2FileReference() throws Exception {
        ...
        Assert.assertEquals(mixMapping,"B400022028241-RT1/400022028241-1/1795-06-15-01/adresseavisen1759-1795-06-15-01-0002.jp2");
    }
    ...
    @Test
     public void testPageNodeReference1() throws Exception {
         ...
         FlaggingFinder flaggingFinder = getFlaggingFinder();
         String mixMapping = flaggingFinder.getFileReferenceFromEvent(mixEvent);
         Assert.assertEquals(mixMapping,"B400022028241-RT1/400022028241-1/1795-06-15-01/adresseavisen1759-1795-06-15-01-0003-brik.jp2");
     }

    @Test
     public void testPageNodeReference2() throws Exception {
         ParsingEvent mixEvent = createNodeBeginsParsingEvent("B400022028241-RT1/400022028241-1/1795-06-15-02/adresseavisen1759-1795-06-15-02-0005B");

         FlaggingFinder flaggingFinder = getFlaggingFinder();
         String mixMapping = flaggingFinder.getFileReferenceFromEvent(mixEvent);
         Assert.assertEquals(mixMapping,"B400022028241-RT1/400022028241-1/1795-06-15-02/adresseavisen1759-1795-06-15-02-0005B.jp2");
     }
    ...
    public void testEditionXmlReference1() throws Exception {
        ParsingEvent mixEvent = createAttributeParsingEvent("B400022028241-RT1/400022028241-1/1795-06-15-01/adresseavisen1759-1795-06-15-01.edition.xml");
    ...
    public void testEditionXmlReference2() throws Exception {
        ParsingEvent mixEvent = createAttributeParsingEvent("B400022028241-RT1/400022028241-1/1795-06-15-02/adresseavisen1759-1795-06-15-02.edition.xml");

        FlaggingFinder flaggingFinder = getFlaggingFinder();
        String mixMapping = flaggingFinder.getFileReferenceFromEvent(mixEvent);
        Assert.assertEquals(mixMapping,"B400022028241-RT1/400022028241-1/1795-06-15-02/adresseavisen1759-1795-06-15-02-0004.jp2");
    }
    ...
    public void testFilmXmlReference() throws Exception {
        ParsingEvent mixEvent = createAttributeParsingEvent("B400022028241-RT1/400022028241-1/adresseavisen1759-400022028241-1.film.xml");

        FlaggingFinder flaggingFinder = getFlaggingFinder();
        String mixMapping = flaggingFinder.getFileReferenceFromEvent(mixEvent);
        Assert.assertEquals(mixMapping,"B400022028241-RT1/400022028241-1/FILM-ISO-target/adresseavisen1759-400022028241-1-ISO-0001.jp2");
    }
    ...
    @Test
     public void testWorkShiftISONodeReference2() throws Exception {
         ParsingEvent mixEvent = createNodeBeginsParsingEvent("B400022028241-RT1/WORKSHIFT-ISO-TARGET/Target-000001-0001");
    ...
    @Test
     public void testFilmISONodeReference2() throws Exception {
         ParsingEvent mixEvent = createNodeBeginsParsingEvent("B400022028241-RT1/400022028241-1/FILM-ISO-target/adresseavisen1759-400022028241-1-ISO-0001");
    ...
    @Test
     public void testUnmatchedNodeReference1() throws Exception {
         ...
         FlaggingFinder flaggingFinder = getFlaggingFinder();
         String mixMapping = flaggingFinder.getFileReferenceFromEvent(mixEvent);
         Assert.assertEquals(mixMapping,"B400022028241-RT1/400022028241-1/UNMATCHED/adresseavisen1759-400022028241-1-0008.jp2");
     }


    @Test
     public void testUnmatchedNodeReference2() throws Exception {
         ParsingEvent mixEvent = createNodeBeginsParsingEvent("B400022028241-RT1/400022028241-1/UNMATCHED/adresseavisen1759-400022028241-1-0008");
